                                                    ...
                                                    <div class="contentEditableContainer contentTextEditable">
                                                        <div style='font-family: Roboto, sans-serif;text-align:left;' class="contentEditable">
                                                            ...
                                                            <p style='font-size:18px;color:#555;'>
                                                                <b>Code42Labs</b> dünyasına adım atmanıza çok az kaldı! 
                                                            </p>
                                                            <br/><br/>
                                                            <p style='font-size:18px;color:#555;'>
                                                                Aşağıdaki linke tıklayarak üyeliğinizi başlatabilirsiniz.
                                                            </p>
                                                            <br/><br/>
                                                            <div style="display: flex; justify-content: center; align-items: center;">
                                                                <a href="${API_HOST}/auth/activate/{{requestId}}" style="padding: 15px; background-color: #301F5D; font-size: 20px; color: white; text-decoration: none; border-radius: 5px">ÜYELİĞİMİ BAŞLAT</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </td>
